...
const hu: Dict = {
  ...
  signup: {
    ...
    submit: "KÜLDÉS",
    sending: "...",
    successNew: "✅ Bent vagy! Az 5% kedvezmény automatikusan érvényesül a kosaradnál.",
    successExisting: "✅ Már fent vagy a listán! Az 5% kedvezmény automatikusan érvényesül a kosaradnál.",
...
const en: Dict = {
  ...
  signup: {
    ...
    submit: "SEND",
    sending: "...",
    successNew: "✅ You're in! Your 5% discount will apply automatically at checkout.",
    successExisting: "✅ You're already on the list! Your 5% discount will apply automatically at checkout.",
