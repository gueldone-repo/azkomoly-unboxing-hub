...
export function CookieBanner() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 px-4 pb-4">
      <div className="mx-auto max-w-3xl bg-dark-bg border-2 border-fire/70 rounded-2xl p-4 sm:p-5 shadow-2xl">
        {!showPrefs ? (
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="bg-fire text-primary-foreground font-display px-4 py-2 rounded-full hover:translate-y-[-1px] transition-transform"
              >
                {t.cookie.acceptAll}
              </button>
              <button
                onClick={() => save({ analytics: false, marketing: false })}
                className="border-2 border-cardboard/60 text-foreground font-sans px-4 py-2 rounded-full hover:border-fire hover:text-fire transition-colors"
              >
          ...
          <div className="flex flex-col gap-3">
            ...
            <label className="flex items-start gap-3 text-sm text-foreground font-sans">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="bg-fire text-primary-foreground font-display px-4 py-2 rounded-full"
              >
                {t.cookie.save}
              </button>
              <button
                onClick={() => setShowPrefs(false)}
                className="border-2 border-cardboard/60 text-foreground font-sans px-4 py-2 rounded-full hover:border-fire hover:text-fire"
              >
                {t.cookie.back}
              </button>
            </div>
