...
/**
 * TextLoop — componente de React Bits (variante JavaScript + CSS), portado a
 * TypeScript porque este proyecto compila con `strict` y sin `allowJs`, así que
 * un .jsx no pasaría `tsc`. La lógica es la del original; lo añadido son tipos.
 */
...
const buildPath = (shape: Shape, curviness: number, ribbonWidth: number): string => {
