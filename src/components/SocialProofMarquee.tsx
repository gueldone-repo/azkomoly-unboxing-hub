...
/**
 * Movido de Home a About (pedido de Diego) — la sección "Real unboxings" /
 * "Valódi nyitások" vive acá tal cual estaba, incluida su prueba social real
 * (reels/TikToks de Instagram propios). `SOCIAL_REVIEWS` sigue siendo el
 * origen de verdad para `LifestyleStrip` en `index.tsx`, que la sigue
 * importando de acá.
 */
